...
class BestPostListAdapter(private val postList: ArrayList<Post>) : RecyclerView.Adapter<BestPostListAdapter.MyViewHolder>() {
    ...
    override fun onBindViewHolder(holder: MyViewHolder, position: Int) {
        ...
        holder.boardNum.text = (position + 1).toString()
