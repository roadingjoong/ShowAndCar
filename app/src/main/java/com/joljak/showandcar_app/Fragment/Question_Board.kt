...
class Question_Board : Fragment() {

    private lateinit var questionBoardAdapter : PostListAdapter
    private lateinit var questionBoardRecyclerView: RecyclerView
    ...
    override fun onCreateView(
        ...
        return inflater.inflate(R.layout.fragment_question__board, container, false)
    }
    ...
    override fun onViewCreated(view : View, savedInstanceState: Bundle?) {
        ...
        questionBoardRecyclerView = view.findViewById(R.id.boardRecyclerView)
        questionBoardRecyclerView.layoutManager = boardLayoutManager
        questionBoardRecyclerView.setHasFixedSize(true)
        ...
        fireStoreDatabase.collection("post")
            ...
            .addOnSuccessListener { result ->
                if (result != null && !result.isEmpty) {
                    ...
                    questionBoardAdapter = PostListAdapter(postList)
                    questionBoardRecyclerView.adapter = questionBoardAdapter
                    questionBoardAdapter.notifyDataSetChanged()

                    // 아이템 클릭 이벤트 처리
                    questionBoardAdapter.setOnItemClickListener(object : PostListAdapter.OnItemClickListener {
        ...
        searchView.setOnQueryTextListener(object : SearchView.OnQueryTextListener {
            ...
            override fun onQueryTextChange(newText: String?): Boolean {
                ...
                questionBoardAdapter.filter(newText.orEmpty())
                return true
            }
        })
