...
class Free_Board : Fragment() {

    private lateinit var freeBoardadapter : PostListAdapter
    private lateinit var freeBoardRecyclerView: RecyclerView
    ...
    override fun onCreateView(
        ...
        return inflater.inflate(R.layout.fragment_free__board, container, false)
    }
    ...
    override fun onViewCreated(view : View, savedInstanceState: Bundle?) {
        ...
        freeBoardRecyclerView = view.findViewById(R.id.boardRecyclerView)
        freeBoardRecyclerView.layoutManager = boardLayoutManager
        freeBoardRecyclerView.setHasFixedSize(true)
        ...
        fireStoreDatabase.collection("post")
            ...
            .addOnSuccessListener { result ->
                if (result != null && !result.isEmpty) {
                    ...
                    freeBoardadapter = PostListAdapter(postList)
                    freeBoardRecyclerView.adapter = freeBoardadapter
                    freeBoardadapter.notifyDataSetChanged()

                    // 아이템 클릭 이벤트 처리
                    freeBoardadapter.setOnItemClickListener(object : PostListAdapter.OnItemClickListener {
        ...
        searchView.setOnQueryTextListener(object : SearchView.OnQueryTextListener {
            ...
            override fun onQueryTextChange(newText: String?): Boolean {
                ...
                freeBoardadapter.filter(newText.orEmpty())
                return true
            }
        })

        // 자유게시판 이동 -> 다시 누르면 커뮤니티 화면으로 이동
