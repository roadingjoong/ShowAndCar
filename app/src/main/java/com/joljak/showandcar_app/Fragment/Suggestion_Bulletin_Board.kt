...
class Suggestion_Bulletin_Board : Fragment() {

    private lateinit var suggestionBulletinBoardAdapter : PostListAdapter
    private lateinit var suggestionBulletinBoardRecyclerView: RecyclerView
    ...
    override fun onCreateView(
        ...
        return inflater.inflate(R.layout.fragment_suggestion__bulletin__board, container, false)
    }
    ...
    override fun onViewCreated(view : View, savedInstanceState: Bundle?) {
        ...
        suggestionBulletinBoardRecyclerView = view.findViewById(R.id.boardRecyclerView)
        suggestionBulletinBoardRecyclerView.layoutManager = boardLayoutManager
        suggestionBulletinBoardRecyclerView.setHasFixedSize(true)
        ...
        fireStoreDatabase.collection("post")
            ...
            .addOnSuccessListener { result ->
                if (result != null && !result.isEmpty) {
                    ...
                    suggestionBulletinBoardAdapter = PostListAdapter(postList)
                    suggestionBulletinBoardRecyclerView.adapter = suggestionBulletinBoardAdapter
                    suggestionBulletinBoardAdapter.notifyDataSetChanged()

                    // 아이템 클릭 이벤트 처리
                    suggestionBulletinBoardAdapter.setOnItemClickListener(object : PostListAdapter.OnItemClickListener {
        ...
        searchView.setOnQueryTextListener(object : SearchView.OnQueryTextListener {
            ...
            override fun onQueryTextChange(newText: String?): Boolean {
                ...
                suggestionBulletinBoardAdapter.filter(newText.orEmpty())
                return true
            }
        })
